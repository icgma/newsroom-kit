...
const SCENARIOS = [
  ...
  },
  {
    id: "paper-writing",
    name: "写论文",
    desc: "算 p 值与效应量、整理参考文献、从 PDF 提取元数据。",
    steps: ["pvalue", "scipdf", "bibfix"],
  },
  {
    id: "interview",
    name: "访谈脱敏",
    desc: "访谈稿匿名化，满足伦理审查要求，导出替换映射表。",
    steps: ["redact"],
  },
];
...
const TOOLS = [
  ...
  },
  {
    ...
    name: "scipdf",
    title: "PDF 元数据提取",
    tagline: "拖入 PDF → 标题、作者、DOI、BibTeX",
